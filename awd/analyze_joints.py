...
urdfs = [
    "data/assets/mini2_bdx/mini2_bdx.urdf",
    "data/assets/go_bdx/go_bdx.urdf",
    "data/assets/mini_bdx/urdf/bdx.urdf",
]


# parse arguments
args = gymutil.parse_arguments(
    description="Generate modelling data for degree-of-freedom ranges",
    custom_parameters=[
        {"name": "--asset_id", "type": int, "default": 0, "help": "Asset id (0 - %d)" % (len(urdfs) - 1)},
        ])
